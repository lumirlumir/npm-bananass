...
interface CliOptions {
  ...
  /**
   * Skip all prompts and accept only CLI options.
   * @default false
   */
  yes?: boolean;

  /**
   * Initialize as a CommonJS project.
   * @default false
   */
  cjs?: boolean;
  ...
  /**
   * Skip initializing visual studio code.
   * @default false
   */
  skipVsc?: boolean;
  ...
  /**
   * Skip installing packages with npm.
   * @default false
   */
  skipInstall?: boolean;
}
...
program
  ...
  .action(async (cliDirectory: string, cliOptions: Required<CliOptions>) => {
    // --------------------------------------------------------------------------
    // CLI
    // --------------------------------------------------------------------------
    ...
    try {
      ...
      throw new Error(error(message, true), { cause: err });
    }
