...
1. 문서 기여: '바나나 프레임워크를 이용한 백준, 코드포스 문제 풀이 및 해설', '바나나 프레임워크 웹사이트 문서', '`README.md`', '`AGENTS.md`' 등.
...
- `LICENSE.md`, `CHANGELOG.md` 및 AI 에이전트 전용 문서인 `AGENTS.md`를 제외한 모든 마크다운 문서들은 반드시 한글 문서(`.md`)와 영문 문서(`.en.md`) 2가지 종류를 작성해야 합니다.
...
- `README.md`, `CONTRIBUTING.md`, `AGENTS.md` 등의 커뮤니티 문서들은 프로젝트의 최상단에 위치합니다.
